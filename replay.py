...
Cannons  = []
Cannons.append(buildings.cannon(1, 11, 7, 6, 5))
Cannons.append(buildings.cannon(2, 11, 13, 6, 5))
...
def manipulate_input(king_last_move,inp):
...
save = input("Enter saved game name: ")

# import array from saved json file
with open('replays/'+save + '.json') as json_file:
    inp_arr = json.load(json_file)

for inp in inp_arr:

    king_last_move = manipulate_input(king_last_move,inp)
    defense()
